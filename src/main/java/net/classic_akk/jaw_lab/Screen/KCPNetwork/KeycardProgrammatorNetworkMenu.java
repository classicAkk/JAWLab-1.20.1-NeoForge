...
public class KeycardProgrammatorNetworkMenu extends AbstractContainerMenu {
    ...
    public KeycardProgrammatorNetworkMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(LabMenuTypes.KCP_NETWORK.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, LabBlocks.KEYCARD_PROGRAMMATOR.get());
    }
