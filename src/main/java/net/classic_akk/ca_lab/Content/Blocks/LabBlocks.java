...
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Decorations.DirectionalBlock;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Decorations.GlassRailings;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Decorations.GlassRailingsCorner;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Decorations.Grating;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.ElectricPanel.*;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.ElevatorButtons.InsideElevatorButton;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.ElevatorButtons.OutsideElevatorButton;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Barrier.BarrierGate;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Barrier.BarrierGateConnector;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Barrier.BarrierGateOff;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.KeyCards.*;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.KeyDoors.*;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.KeycardProgrammator;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.LED_Lamp;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Pickable.WireCuttersBlock;
import net.classic_akk.ca_lab.Lab;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Pickable.CrowbarBlock;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Pickable.DuctTapeBlock;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Pickable.FuseBlock;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Sheets.EmptySheetBlock;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Sheets.SheetBlock;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Stamps.GreenStamp;
import net.classic_akk.ca_lab.Content.Blocks.Blocks.Stamps.RedStamp;
import net.classic_akk.ca_lab.Content.Items.LabItems;
